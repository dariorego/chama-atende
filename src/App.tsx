...
import AdminHygiene from "./pages/admin/AdminHygiene";
import AdminShelfLife from "./pages/admin/AdminShelfLife";
      ...
      <ThemeProvider storageKey="admin-theme" defaultTheme="light">
        ...
        <Routes>
          ...
          <Route
            path="higiene"
            element={
              <AuthGuard requireAdmin section="higiene">
                <AdminLayout>
                  <AdminHygiene />
                </AdminLayout>
              </AuthGuard>
          ...
          <Route
            path="validades"
            element={
              <AuthGuard requireAdmin section="validades">
                <AdminLayout>
                  <AdminShelfLife />
                </AdminLayout>
              </AuthGuard>
